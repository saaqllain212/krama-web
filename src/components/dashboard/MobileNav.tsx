...
import { 
  ...
  Menu, X, ChevronRight, Sparkles, Brain
} from 'lucide-react'
  ...
  return (
    <>
      ...
      <div className="sticky top-0 z-30 flex h-16 items-center justify-between border-b border-gray-200 bg-white px-4 lg:hidden">
        ...
        <button onClick={() => setIsOpen(true)} className="p-2 hover:bg-gray-100 rounded-lg transition-colors">
          ...
          <>
            ...
            >
              <div className="flex h-16 items-center justify-between border-b border-gray-200 px-5">
                ...
                <button onClick={() => setIsOpen(false)} className="p-2 hover:bg-red-50 hover:text-red-600 rounded-lg transition-colors">
              ...
              <div className="border-b border-gray-200 p-5">
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="text-sm text-gray-500 font-medium">{stats.percentage}% complete</div>
                  </div>
                </div>
                  ...
                  return (
                    <Link key={item.href} href={item.href} onClick={() => setIsOpen(false)}
                      className={`flex items-center justify-between px-4 py-3 rounded-lg text-sm font-medium transition-all active:scale-[0.98]
                        ${isActive ? 'bg-primary-500 text-white shadow-soft' : 'text-gray-700 hover:bg-gray-50'}`}>
                      <div className="flex items-center gap-3">
