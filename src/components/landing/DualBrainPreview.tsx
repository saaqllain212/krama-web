...
export default function DualBrainPreview() {
  return (
    <section className="relative px-6 py-24 md:px-12 bg-white overflow-hidden">
      <div className="absolute top-0 right-0 w-96 h-96 bg-green-100/60 rounded-full blur-3xl"/>
      <div className="absolute bottom-0 left-0 w-96 h-96 bg-amber-100/60 rounded-full blur-3xl"/>
      <div className="relative z-10 max-w-7xl mx-auto">
        <div className="text-center mb-14">
          ...
          <h2 className="text-3xl md:text-5xl font-black text-gray-900 mb-4 tracking-tight">
            Two companions watching you.<br/><span className="text-gradient">One rewards. One haunts.</span>
          </h2>
          <p className="text-lg text-gray-500 font-medium max-w-2xl mx-auto">Sounds weird. Works incredibly well. Students with companions study 40% more consistently.</p>
        </div>
        <div className="grid md:grid-cols-2 gap-6 max-w-5xl mx-auto">
          <motion.div initial={{opacity:0,y:20}} whileInView={{opacity:1,y:0}} viewport={{once:true}}
            ...
            <p className="text-gray-600 mb-5 leading-relaxed">Every focus session makes your Guardian grow. Skip study and it wilts. Seeing it grow makes students genuinely proud — and coming back every day.</p>
            <div className="bg-green-50 rounded-xl p-5 border border-green-200 mb-4">
              ...
              <div className="space-y-2.5">
                {[['0–25h','Tiny Seed 🌱'],['25–100h','Growing Sapling 🌿'],['100–250h','Flourishing Tree 🌳'],['250h+','Ancient Guardian 🌲']].map(([h,l])=>(
                  <div key={h} className="flex items-center gap-2.5">
                    <div className="w-1.5 h-1.5 bg-green-500 rounded-full shrink-0"/>
                    <span className="text-sm font-semibold text-gray-700"><span className="font-black text-green-700">{h}</span> · {l}</span>
                  </div>
                ))}
              </div>
            </div>
            <div className="bg-white rounded-xl p-3.5 border border-green-200 flex items-start gap-2.5">
              ...
              <p className="text-sm text-gray-700 font-medium italic">"You studied 4 hours today! I grew 3 new branches."</p>
            </div>
          </motion.div>
          ...
          <motion.div initial={{opacity:0,y:20}} whileInView={{opacity:1,y:0}} viewport={{once:true}} transition={{delay:0.1}}
            ...
            <p className="text-gray-600 mb-5 leading-relaxed">The Wraith grows powerful every day you don't study. It calls you out directly. Students say the Wraith is the reason they don't skip "just one more day."</p>
            <div className="bg-amber-50 rounded-xl p-5 border border-amber-200 mb-4">
              ...
              <div className="space-y-2.5">
                {[['Day 1 missed','Whispering shadow 👤'],['Day 2–3','Growing presence 👻'],['Day 4–5','Menacing Wraith 😰'],['Week missed','The Devourer 💀']].map(([h,l])=>(
                  <div key={h} className="flex items-center gap-2.5">
                    <div className="w-1.5 h-1.5 bg-amber-500 rounded-full shrink-0"/>
                    <span className="text-sm font-semibold text-gray-700"><span className="font-black text-amber-700">{h}</span> · {l}</span>
                  </div>
                ))}
              </div>
            </div>
            <div className="bg-white rounded-xl p-3.5 border border-amber-200 flex items-start gap-2.5">
              ...
              <p className="text-sm text-gray-700 font-medium italic">"You haven't studied in 2 days. I'm watching. Is this the plan?"</p>
            </div>
          </motion.div>
        </div>
      </div>
