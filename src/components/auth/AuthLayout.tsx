    ...
    <>
      ...
      <div className="flex min-h-screen w-full">
        ...
        <div className="relative hidden w-1/2 flex-col justify-between p-10 lg:flex lg:p-12 overflow-hidden bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900">
          ...
          {mode === 'signup' ? (
            <>
              <div className="absolute top-20 right-20 w-64 h-64 bg-success-500/20 rounded-full mix-blend-screen filter blur-3xl animate-pulse" />
              <div className="absolute bottom-20 left-20 w-72 h-72 bg-success-400/15 rounded-full mix-blend-screen filter blur-3xl animate-pulse" style={{ animationDelay: '1s' }} />
            </>
          ) : (
            <>
              <div className="absolute top-20 right-20 w-64 h-64 bg-warning-500/20 rounded-full mix-blend-screen filter blur-3xl animate-pulse" />
              <div className="absolute bottom-20 left-20 w-72 h-72 bg-warning-400/15 rounded-full mix-blend-screen filter blur-3xl animate-pulse" style={{ animationDelay: '1s' }} />
            </>
          )}
        ...
        <div className="flex w-full flex-col bg-white lg:w-1/2">
          ...
          {/* Footer */}
          <div className="p-6 text-center text-xs text-gray-400 lg:p-8">
